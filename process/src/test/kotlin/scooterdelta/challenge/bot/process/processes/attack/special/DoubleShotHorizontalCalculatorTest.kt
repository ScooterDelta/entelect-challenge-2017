...
class DoubleShotHorizontalCalculatorTest {
    ...
    @Test fun testSingleProbabilityAgain() {
        val testCell = gameState.opponentMap.map.getCellFromMap(4, 1) as OpponentCell
        probabilityCalculator.calculateProbability(testCell, gameState, processOutcomes)
    ...
    @Test fun testSingleProbabilityEdgeTestTargetHit() {
        val testCell = gameState.opponentMap.map.getCellFromMap(0, 1) as OpponentCell
        probabilityCalculator.calculateProbability(testCell, gameState, processOutcomes)
    ...
    @Test fun testZeroProbability() {
        val testCell = gameState.opponentMap.map.getCellFromMap(1, 5) as OpponentCell
        probabilityCalculator.calculateProbability(testCell, gameState, processOutcomes)
    ...
    @Test fun testZeroProbabilityAgain() {
        val testCell = gameState.opponentMap.map.getCellFromMap(1, 4) as OpponentCell
        probabilityCalculator.calculateProbability(testCell, gameState, processOutcomes)
